...
const Main = () => {
  ...
  return (
    <div
      className={`max-h-screen grid grid-cols-1 md:grid-cols-2 relative top-0 p-8 bg-[#fefae0] dark:bg-gray-900`}
    >
      {loading ? (
        <Spinner />
      ) : (
        <>
          <div className="flex flex-col justify-end md:justify-center items-center md:items-start p-5 md:p-10 md:ml-10">
            <h1 className="text-3xl md:text-5xl lg:text-8xl font-bold mb-6">
              Online Shopping
            </h1>
            <p className="text-center">
              Now, Everything at your Door-Step because of E-Shopping.
            </p>
