          ...
          {headphones.map((item, index) => {
            return (
              <div className="flex justify-center items-center flex-col space-y-5 rounded-xl shadow-md" key={index}>
                <div className="w-60 h-60 rounded-xl bg-green-100">
                  <Image
                    src={item.img}
                    alt="Headphones"
                    width={1}
                ...
                <div className="flex justify-between items-center w-full h-full px-5 py-3">
                  ...
                  <button className="w-28 h-10 bg-green-100 hover:bg-green-200 rounded-xl text-sm font-semibold border-2">Add To Cart</button>
